 ...
 *       &lt;sequence>
 *         &lt;element name="userCollection" type="{http://localhost:8090/ws}user" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class UserCollectionResponse {
    ...
    protected List<User> userCollection;
     ...
     * This is why there is not a <CODE>set</CODE> method for the userCollection property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUserCollection().add(newItem);
     * </pre>
     * 
     * 
     * <p>
