 ...
 *       &lt;sequence>
 *         &lt;element name="eventCollection" type="{http://localhost:8090/ws}event" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class EventCollectionResponse {
     ...
     * This is why there is not a <CODE>set</CODE> method for the eventCollection property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEventCollection().add(newItem);
     * </pre>
     * 
     * 
     * <p>
